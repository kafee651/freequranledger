...
<div id="wrap">
	...
	<div id="content-outer" class="clear"><div id="content-wrap">
       ...
       <table width="1000" height="1" border="0" align="center" >
            ...
            <tr colspan=0>
  	        <td align="Center" colspan="7"><h2 align="center">Delivered Order List</h2>
            </td>
            </tr>
            ...
            <th width="100" scope="row"> <p align="left">Delivered BY</p></th>
			<th width="100" scope="row"> <p align="left">Delivered ON</p></th>
...
<?php
	...
	$sino = 1;
	$query = mysql_query("select * from `order` where status = 3", $con);
