                        ...
                        <table width="482" height="415" border="0" align="left" >
                          ...
                          <?php
                            ...
                            while($row = mysql_fetch_array($query)){
                              ...
                              echo "<form action='./assignedupdate_comp.php' name='input' method='POST' >";
                              ...
                              echo "<tr> <th width='87' scope='row'><p align='left'>Assign To<font color='#FF0000'>*</font></p></th>";
                              echo "<td colspan='4'><font face='Verdana' size='2'>";
                              echo "<input size='15' maxlength='50' name='asignto' type='text' id='name' /></font></td></tr>";
                              
                              echo "<tr> <th width='87' scope='row'><p align='left'>Assign Review<font color='#FF0000'>*</font></p></th>";
                              echo "<td colspan='4'><font face='Verdana' size='2'>";
                              echo "<input size='15' maxlength='100' name='assignreview' type='text' id='name' /></font></td></tr>";
