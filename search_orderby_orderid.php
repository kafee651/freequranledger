                  ...
                  <table width="400" border="0" cellspacing="0" cellpadding="0">
                    <tr><td width="100%">
                        ...
                        <table width="482" height="415" border="0" align="left" >
                          <tr colspan=0><td align="Center" colspan="6"><h2 align="center">Order Details</h2></td>
                          </tr>
                          ...
                          <?php
                            ...
                            while($row = mysql_fetch_array($query)){
                              ...
                              echo "<!-- Delivered Review Row-->";
                              echo "<tr><th width='87' scope='row'><p align='left'>Delivered Review</p></th>";
                              echo "<td colspan='4'><font face='Verdana' size='2'>$row[deliveredreview]</font></td></tr>";

                              echo "<!-- Delivered Date Row-->";
                              echo "<tr><th width='87' scope='row'><p align='left'>Delivered Date</p></th>";
                              echo "<td colspan='4'><font face='Verdana' size='2'>$row[delivereddate]</font></td></tr>";

                              echo "<!-- Delivered by Row-->";
                              echo "<tr><th width='87' scope='row'><p align='left'>Delivered By</p></th>";
                              echo "<td colspan='4'><font face='Verdana' size='2'>$row[deliveredby]</font></td></tr>"; 
                            }
                            mysql_close($con);
                          ?>
                          <!-- Reivew of Order-->
