                    ...
                    <table width="400" border="0" cellspacing="0" cellpadding="0">
                        <tr><td width="100%"><form action="./search_orderby_orderid.php" method="POST" >
                                    <table width="494" height="215" border="0" align="left" >
                                        ...
                                        <tr>
                                        <th width="200" scope="row"><p align="left">Order ID<font color="#FF0000">*</font></p></th>
                                            <td colspan="4" width="100"><font face='Verdana' size='2'>
                                                <input size="30" maxlength="100" name="orderid" type="text" id="name" /></font>
                                            </td>
                                        </tr>
                                        <tr><th height="78" colspan="6" align="left" scope="row">
                                            <font color="#FF0000">*</font>All fields are compulsory<br/>
                    ...
                    <table width="400" border="0" cellspacing="0" cellpadding="0">
                        <tr><td width="100%"><form action="./search_date_comp.php" method="POST" >
                                    <table width="494" height="415" border="0" align="left" >
                                        <tr colspan=0><td align="Center" colspan="6">
                                                <h2 align="center">Search  Order List</h2></td></tr>
                                        <tr><th scope="row" align="left">Category<font color="#FF0000">*</font></th>
                                            <td colspan="4"><label>
                                                <select name="status">
                                                    <option value="0">ALL</option>
                                                    <option value="1">New Order</option>
                                                    <option value="2">Assigned Order</option>
                                                    <option value="3">Delivered Order</option>
                                               </select>
                                            </label></td>
                                        </tr>
                                        <tr>
